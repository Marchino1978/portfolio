...
// Definizione colori logici → valori GRB

// Colori primari
#define LED_ROSSO   0,255,0     // Rosso logico → appare rosso
#define LED_VERDE   255,0,0     // Verde logico → appare verde
#define LED_BLU     0,0,255     // Blu logico → appare blu

// Colori secondari
#define LED_GIALLO  255,255,0   // Verde+Rosso → appare giallo
...
// Colori extra
#define LED_VIOLA   0,128,128   // Viola
#define LED_OLIVA   128,128,0   // Oliva
#define LED_AZZURRO 0,0,200     // Azzurro
